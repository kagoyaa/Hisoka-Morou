...
if (!Number(text)) throw `Example : ${prefix + command} 6282260624836`
...
if (!text) throw `Example : ${prefix + command} Rasy, 27, 11, 2006, Evie, 16, 11, 2006`
...
break
case 'artinama': {
if (!text) throw `Example : ${prefix + command} Rasyid`
...
if (!text) throw `Example : ${prefix + command} Rasy, 27, 11, 2006`
...
if (!text) throw `Example : ${prefix + command} Rasy|Evie`
...
break
case 'fengshui': {
if (!text) throw `Example : ${prefix + command} Rasy, 1, 2006\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
break
case 'peruntungan': {
if (!text) throw `Example : ${prefix + command} Rasy, 27, 11, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
if (!text) throw `Example : ${prefix + command} 27, 11, 2006`
let [tgl, bln, thn] = text.split`,`
...
hisoka.send5ButImg(m.chat, anu, `Status: User Yuka Bot\nNama: ${pushname}`, global.thumb, btn)
}
break
case 'rules':
m.reply(global.rules)
break
default:
if (budy.startsWith('=>')) {
